      ...
      <div className="p-4 bg-white rounded-14 shadow-sm vh-85">
        <Row className="py-2">
          <div className="mx-auto col-lg-7 d-flex align-items-center flex-column">
            ...
            <Link className="d-block p-3 text-dark bg-grey w-100 rounded-14 mt-2" to="/dashboard/profile/change_password">
              <div className="d-flex justify-content-between">
            ...
            <Link className="d-block p-3 text-dark bg-grey w-100 rounded-14 mt-2" to="/dashboard/profile/change_pin">
              <div className="d-flex justify-content-between">
                <div>Change PIN</div>
                <Icons iconName="arrow-right" iconWidth={24} iconHeight={24} />
              </div>
